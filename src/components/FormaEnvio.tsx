...
const FormaEnvio: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center mt-16">
            <div className="mb-4">
                    <h1 className="text-black font-bold">CONFIRME O ENVIO</h1>
                </div>

                {/* Componente de Envio */}
            <div className="w-96 p-4 bg-gray-100 border border-gray-300 rounded-lg shadow-md">
                {/* Título do Envio */}
                <h1 className="text-lg font-bold text-black">Transportadora</h1>
                {/* Subtítulo */}
                <p className="text-gray-600 mt-2">Tempo:</p>
