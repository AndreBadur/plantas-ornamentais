      ...
      <table className="table-auto border-separate border border-slate-400 w-full">
        ...
        <tbody>
          {products.map((product) => (
            ...
            */
            <tr key={product.id} className="text-left border border-b-[1px]">
              <th className="border border-slate-300">{product.id}</th>
              <th className="border border-slate-300">{product.title}</th>
              <th className="border border-slate-300">{product.description}</th>
